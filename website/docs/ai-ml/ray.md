...
Ensure that you have installed the following tools on your machine. You can use the helper script `cloud9-init.sh` from the git repo you will clone in the next steps. 
